...
def alternative_fuel_vehicles():
    ...
    '''
    run_command('alternative_fuel_vehicles')
...
def average_teacher_salary():
    ...
    '''
    run_command('average_teacher_salary')
...
def bilingual_ed_spending():
    ...
    '''
    run_command('bilingual_ed_spending')
...
def budget_category_subfunctions():
    ...
    '''
    run_command('budget_category_subfunctions')
...
def cffr_annual_agency():
    ...
    '''
    run_command('cffr_annual_agency')
...
def cffr_annual_pre93_geo():
    ...
    '''
    run_command('cffr_annual_pre93_geo')
...
def diploma_recipient_total():
    ...
    '''
    run_command('diploma_recipient_total')
...
def drug_free_school_spending():
    ...
    '''
    run_command('drug_free_school_spending')
...
def educational_attainment():
    ...
    '''
    run_command('educational_attainment')
...
def electric_emissions():
    ...
    '''
    run_command('electric_emissions')
...
def ell_students_district():
    ...
    '''
    run_command('ell_students_district')
...
def energy_consumption():
    ...
    '''
    run_command('energy_consumption')
...
def energy_expenditures_state_annual():
    ...
    '''
    run_command('energy_expenditures_state_annual')
...
def energy_state_production_estimates():
    ...
    '''
    run_command('energy_state_production_estimates')
...
def enrolled_students_district():
    ...
    '''
    run_command('enrolled_students_district')
...
def expenditure_per_pupil():
    ...
    '''
    run_command('expenditure_per_pupil')
...
def federal_impact_aid():
    ...
    '''
    run_command('federal_impact_aid')
...
def federal_tax_collection():
    ...
    '''
    run_command('federal_tax_collection')
...
def fips_countycongressdistrict():
    ...
    '''
    run_command('fips_countycongressdistrict')
...
def free_lunch_eligible():
    ...
    '''
    run_command('free_lunch_eligible')
...
def free_reduced_lunch_eligible():
    ...
    '''
    run_command('free_reduced_lunch_eligible')
...
def free_reduced_lunch_eligible_county():
    ...
    '''
    run_command('free_reduced_lunch_eligible_county')
...
def head_start_enrollment():
    ...
    '''
    run_command('head_start_enrollment')
...
def health_insurance_children():
    ...
    '''
    run_command('health_insurance_children')
...
def individual_education_programs():
    ...
    '''
    run_command('individual_education_programs')
...
def labor_force_county():
    ...
    '''
    run_command('labor_force_county')
...
def labor_underutilization():
    ...
    '''
    run_command('labor_underutilization')
...
def math_science_spending():
    ...
    '''
    run_command('math_science_spending')
...
def median_household_income():
    ...
    '''
    run_command('median_household_income')
...
def medicaid_participation():
    ...
    '''
    run_command('medicaid_participation')
...
def medicare_enrollment():
    ...
    '''
    run_command('medicare_enrollment')
...
def military_personnel():
    ...
    '''
    run_command('military_personnel')
...
def native_ed_spending():
    ...
    '''
    run_command('native_ed_spending')
...
def other_federal_revenue():
    ...
    '''
    run_command('other_federal_revenue')
...
def population_congressional_district():
    ...
    '''
    run_command('population_congressional_district')
...
def population_families():
    ...
    '''
    run_command('population_families')
...
def presidents_budget_receipts():
    ...
    '''
    run_command('presidents_budget_receipts')
...
def pupil_teacher_district():
    ...
    '''
    run_command('pupil_teacher_district')
...
def retired_disabled_nilf():
    ...
    '''
    run_command('retired_disabled_nilf')
...
def saipe_county_state():
    ...
    '''
    run_command('saipe_county_state')
...
def school_breakfast_participation():
    ...
    '''
    run_command('school_breakfast_participation')
...
def school_lunch_participation():
    ...
    '''
    run_command('school_lunch_participation')
...
def shelter_population():
    ...
    '''
    run_command('shelter_population')
...
def snap_benefits_recipients():
    ...
    '''
    run_command('snap_benefits_recipients')
...
def snap_monthly_benefits_person():
    ...
    '''
    run_command('snap_monthly_benefits_person')
...
def snap_participation_households():
    ...
    '''
    run_command('snap_participation_households')
...
def snap_participation_people():
    ...
    '''
    run_command('snap_participation_people')
...
def special_ed_funding():
    ...
    '''
    run_command('special_ed_funding')
...
def state_completion_rate():
    ...
    '''
    run_command('state_completion_rate')
...
def state_unemployment():
    ...
    '''
    run_command('state_unemployment')
...
def summer_lunch_participation():
    ...
    '''
    run_command('summer_lunch_participation')
...
def tanf_participation():
    ...
    '''
    run_command('tanf_participation')
...
def vehicle_registrations():
    ...
    '''
    run_command('vehicle_registrations')
...
def vocational_ed_spending():
    ...
    '''
    run_command('vocational_ed_spending')
...
def wic_benefits_state():
    ...
    '''
    run_command('wic_benefits_state')
...
def wic_participation_state():
    ...
    '''
    run_command('wic_participation_state')

def run_command(command):
    with cd(env.repo_path):
        env.import_command = command
        sudo(
            '%(bin_path)s/python manage.py import_%(import_command)s --verbosity=2 --traceback' % env,
            user='npp'
        )
