...
class HealthInsuranceStateRaw(models.Model):
    ...
    pop_under_18 = models.IntegerField()
    pop_under_18_moe = models.IntegerField()
    pop_under_18_private = models.IntegerField()
    pop_under_18_private_moe = models.IntegerField()
    pop_under_18_public = models.IntegerField()
    pop_under_18_public_moe = models.IntegerField()
    pop_under_18_private_public = models.IntegerField()
    pop_under_18_private_public_moe = models.IntegerField()
    pop_under_18_no_ins = models.IntegerField()
    pop_under_18_no_ins_moe = models.IntegerField()
    pop_18_34 = models.IntegerField()
    pop_18_34_moe = models.IntegerField()
    pop_18_34_private = models.IntegerField()
    pop_18_34_private_moe = models.IntegerField()
    pop_18_34_public = models.IntegerField()
    pop_18_34_public_moe = models.IntegerField()
    pop_18_34_private_public = models.IntegerField()
    pop_18_34_private_public_moe = models.IntegerField()
    pop_18_34_no_ins = models.IntegerField()
    pop_18_34_no_ins_moe = models.IntegerField()
    pop_35_64 = models.IntegerField()
    pop_35_64_moe = models.IntegerField()
    pop_35_64_private = models.IntegerField()
    pop_35_64_private_moe = models.IntegerField()
    pop_35_64_public = models.IntegerField()
    pop_35_64_public_moe = models.IntegerField()
    pop_35_64_private_public = models.IntegerField()
    pop_35_64_private_public_moe = models.IntegerField()
    pop_35_64_no_ins = models.IntegerField()
    pop_35_64_no_ins_moe = models.IntegerField()
    pop_over_64 = models.IntegerField()
    pop_over_64_moe = models.IntegerField()
    pop_over_64_private = models.IntegerField()
    pop_over_64_private_moe = models.IntegerField()
    pop_over_64_public = models.IntegerField()
    pop_over_64_public_moe = models.IntegerField()
    pop_over_64_private_public = models.IntegerField()
    pop_over_64_private_public_moe = models.IntegerField()
    pop_over_64_no_ins = models.IntegerField()
    pop_over_64_no_ins_moe = models.IntegerField()
    create_date = models.DateTimeField(auto_now_add=True)
    update_date = models.DateTimeField(auto_now=True)
...
class HousingOccupancyStateRaw(models.Model):
    year = models.IntegerField()
    state = models.CharField(max_length=255)
    state_fips = models.CharField(max_length=2)
    total_units = models.IntegerField()
    total_units_moe = models.CharField(max_length=10)
    occupied_units = models.IntegerField()
    occupied_units_moe = models.CharField(max_length=10)
    occupied_units_percent = models.DecimalField(max_digits=5,decimal_places=2,null=True)
    occupied_units_percent_moe = models.CharField(max_length=10,null=True)
    vacant_units = models.IntegerField()
    vacant_units_moe = models.CharField(max_length=10)
    vacant_units_percent = models.DecimalField(max_digits=5,decimal_places=2,null=True)
    vacant_units_percent_moe = models.CharField(max_length=10, null=True)
    owner_occupied = models.IntegerField()
    owner_occupied_moe = models.CharField(max_length=10)
    owner_occupied_percent = models.DecimalField(max_digits=5,decimal_places=2,null=True)
    owner_occupied_percent_moe = models.CharField(max_length=10,null=True)
    owner_vacancy_rate = models.DecimalField(max_digits=5,decimal_places=2)
    owner_vacancy_rate_moe = models.CharField(max_length=10)
    renter_occupied = models.IntegerField()
    renter_occupied_moe = models.CharField(max_length=10)
    renter_occupied_percent = models.DecimalField(max_digits=5,decimal_places=2,null=True)
    renter_occupied_percent_moe = models.CharField(max_length=10,null=True)
    renter_vacancy_rate = models.DecimalField(max_digits=5,decimal_places=2)
    renter_vacancy_rate_moe = models.CharField(max_length=10)
    create_date = models.DateTimeField(auto_now_add=True)
    update_date = models.DateTimeField(auto_now=True)
...
class HealthInsuranceState(models.Model):
    year = models.IntegerField()
    state = models.ForeignKey(State)
    pop = models.IntegerField()
    pop_moe = models.IntegerField()
    pop_ins = models.IntegerField()
    pop_ins_percent = models.DecimalField(max_digits=5, decimal_places=2)
    pop_no_ins = models.IntegerField()
    pop_no_ins_percent = models.DecimalField(max_digits=5, decimal_places=2)
    pop_under_18 = models.IntegerField()
    pop_under_18_moe = models.IntegerField()
    pop_under_18_private = models.IntegerField()
    pop_under_18_private_moe = models.IntegerField()
    ...
    pop_under_18_private_public = models.IntegerField()
    pop_under_18_private_public_moe = models.IntegerField()
    pop_under_18_ins = models.IntegerField()
    pop_under_18_ins_percent = models.DecimalField(max_digits=5, decimal_places=2)
    pop_under_18_ins_percent_moe = models.DecimalField(max_digits=5, decimal_places=2)
    pop_under_18_no_ins = models.IntegerField()
    pop_under_18_no_ins_moe = models.IntegerField()
    pop_under_18_no_ins_percent = models.DecimalField(max_digits=5,decimal_places=2)
    pop_under_18_no_ins_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    pop_18_34 = models.IntegerField()
    pop_18_34_moe = models.IntegerField()
    pop_18_34_private = models.IntegerField()
    pop_18_34_private_moe = models.IntegerField()
    ...
    pop_18_34_private_public = models.IntegerField()
    pop_18_34_private_public_moe = models.IntegerField()
    pop_18_34_ins = models.IntegerField()
    pop_18_34_ins_percent = models.DecimalField(max_digits=5, decimal_places=2)
    pop_18_34_ins_percent_moe = models.DecimalField(max_digits=5, decimal_places=2)
    pop_18_34_no_ins = models.IntegerField()
    pop_18_34_no_ins_moe = models.IntegerField()
    pop_18_34_no_ins_percent = models.DecimalField(max_digits=5,decimal_places=2)
    pop_18_34_no_ins_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    pop_35_64 = models.IntegerField()
    pop_35_64_moe = models.IntegerField()
    pop_35_64_private = models.IntegerField()
    pop_35_64_private_moe = models.IntegerField()
    ...
    pop_35_64_private_public = models.IntegerField()
    pop_35_64_private_public_moe = models.IntegerField()
    pop_35_64_ins = models.IntegerField()
    pop_35_64_ins_percent = models.DecimalField(max_digits=5, decimal_places=2)
    pop_35_64_ins_moe = models.DecimalField(max_digits=5, decimal_places=2)
    pop_35_64_no_ins = models.IntegerField()
    pop_35_64_no_ins_moe = models.IntegerField()
    pop_35_64_no_ins_percent = models.DecimalField(max_digits=5,decimal_places=2)
    pop_35_64_no_ins_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    pop_18_64 = models.IntegerField()
    pop_18_64_moe = models.IntegerField()
    pop_18_64_private = models.IntegerField()
    pop_18_64_private_moe = models.IntegerField()
    pop_18_64_public = models.IntegerField()
    pop_18_64_public_moe = models.IntegerField()
    pop_18_64_private_public = models.IntegerField()
    pop_18_64_private_public_moe = models.IntegerField()
    pop_18_64_ins = models.IntegerField()
    pop_18_64_ins_percent = models.DecimalField(max_digits=5, decimal_places=2)
    pop_18_64_ins_percent_moe = models.DecimalField(max_digits=5, decimal_places=2)
    pop_18_64_no_ins = models.IntegerField()
    pop_18_64_no_ins_moe = models.IntegerField()
    pop_18_64_no_ins_percent = models.DecimalField(max_digits=5,decimal_places=2)
    pop_18_64_no_ins_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    pop_over_64 = models.IntegerField()
    pop_over_64_moe = models.IntegerField()
    pop_over_64_private = models.IntegerField()
    pop_over_64_private_moe = models.IntegerField()
    ...
    pop_over_64_private_public = models.IntegerField()
    pop_over_64_private_public_moe = models.IntegerField()
    pop_over_64_ins = models.IntegerField()
    pop_over_64_ins_percent = models.DecimalField(max_digits=5, decimal_places=2)
    pop_over_64_ins_percent_moe = models.DecimalField(max_digits=5, decimal_places=2)
    pop_over_64_no_ins = models.IntegerField()
    pop_over_64_no_ins_moe = models.IntegerField()
    pop_over_64_no_ins_percent = models.DecimalField(max_digits=5,decimal_places=2)
    pop_over_64_no_ins_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    create_date = models.DateTimeField(auto_now_add=True)
    update_date = models.DateTimeField(auto_now=True)
...
class HousingOccupancyState(models.Model):
    year = models.IntegerField()
    state = models.ForeignKey(State)
    total_units = models.IntegerField()
    total_units_moe = models.IntegerField()
    occupied_units = models.IntegerField()
    occupied_units_moe = models.IntegerField()
    occupied_units_percent = models.DecimalField(max_digits=5,decimal_places=2)
    occupied_units_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    vacant_units = models.IntegerField()
    vacant_units_moe = models.IntegerField()
    vacant_units_percent = models.DecimalField(max_digits=5,decimal_places=2)
    vacant_units_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    owner_occupied = models.IntegerField()
    owner_occupied_moe = models.IntegerField()
    owner_occupied_percent = models.DecimalField(max_digits=5,decimal_places=2)
    owner_occupied_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    owner_vacancy_rate = models.DecimalField(max_digits=5,decimal_places=2)
    owner_vacancy_rate_moe = models.DecimalField(max_digits=5,decimal_places=2)
    renter_occupied = models.IntegerField()
    renter_occupied_moe = models.IntegerField()
    renter_occupied_percent = models.DecimalField(max_digits=5,decimal_places=2)
    renter_occupied_percent_moe = models.DecimalField(max_digits=5,decimal_places=2)
    renter_vacancy_rate = models.DecimalField(max_digits=5,decimal_places=2)
    renter_vacancy_rate_moe = models.DecimalField(max_digits=5,decimal_places=2)
    create_date = models.DateTimeField(auto_now_add=True)
    update_date = models.DateTimeField(auto_now=True)
