...
class ElectricEmissionsStateRaw(models.Model):
    ...
    co2 = models.BigIntegerField(null=True)
    so2 = models.BigIntegerField(null=True)
    nox = models.BigIntegerField(null=True)
    create_date = models.DateTimeField(auto_now_add=True)
    update_date = models.DateTimeField(auto_now=True)
...
class Cfda(models.Model):
    ...
    preapplication_coordination = models.TextField()
    application_procedure = models.TextField()
    award_procedure = models.TextField()
    deadline = models.TextField()
    approval_time_range = models.TextField()
    appeals = models.TextField()
    renewal = models.TextField()
    formula_matching_grant_request = models.TextField()
    assistance_length_time = models.TextField()
    reports = models.TextField()
    audits = models.TextField()
    record = models.TextField()
    account_id = models.TextField()
    obligations = models.TextField()
    range_average_assistance = models.TextField()
    accomplishments = models.TextField()
    regulations = models.TextField()
    regional_local_office = models.TextField()
    headquarters_office = models.TextField()
    web_address = models.TextField()
    #related_program 
    example_projects = models.TextField()
    selection_criteria = models.TextField()
    url = models.CharField(max_length=50)
    recovery_flag = models.BooleanField()
    omb_agency_code = models.CharField(max_length=10)
    omb_bureau_code = models.CharField(max_length=10)
