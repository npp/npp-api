...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsaspendingAssistanceState'
        db.create_table('data_usaspendingassistancestate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('cfda', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Cfda'])),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.State'])),
            ('fed_funding', self.gf('django.db.models.fields.BigIntegerField')()),
            ('loan_value', self.gf('django.db.models.fields.BigIntegerField')()),
            ('loan_subsidy', self.gf('django.db.models.fields.BigIntegerField')()),
            ('fed_funding_per_capita', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2)),
            ('loan_value_per_capita', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2)),
            ('loan_subsidy_per_capita', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('data', ['UsaspendingAssistanceState'])

        # Adding unique constraint on 'UsaspendingAssistanceState', fields ['year', 'cfda', 'state']
        db.create_unique('data_usaspendingassistancestate', ['year', 'cfda_id', 'state_id'])

        # Adding model 'UsaspendingAssistanceCounty'
        db.create_table('data_usaspendingassistancecounty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('cfda', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Cfda'])),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.State'])),
        ...
        db.send_create_signal('data', ['UsaspendingAssistanceCounty'])

        # Adding unique constraint on 'UsaspendingAssistanceCounty', fields ['year', 'cfda', 'state', 'county']
        db.create_unique('data_usaspendingassistancecounty', ['year', 'cfda_id', 'state_id', 'county_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UsaspendingAssistanceCounty', fields ['year', 'cfda', 'state', 'county']
        db.delete_unique('data_usaspendingassistancecounty', ['year', 'cfda_id', 'state_id', 'county_id'])

        # Removing unique constraint on 'UsaspendingAssistanceState', fields ['year', 'cfda', 'state']
        db.delete_unique('data_usaspendingassistancestate', ['year', 'cfda_id', 'state_id'])

        # Deleting model 'UsaspendingAssistanceState'
        db.delete_table('data_usaspendingassistancestate')

        # Deleting model 'UsaspendingAssistanceCounty'
        db.delete_table('data_usaspendingassistancecounty')
