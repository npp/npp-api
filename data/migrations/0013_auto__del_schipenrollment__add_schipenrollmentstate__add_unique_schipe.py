...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SchipEnrollmentState'
        db.create_table('data_schipenrollmentstate', (
        ...
        db.send_create_signal('data', ['SchipEnrollmentState'])

        # Adding unique constraint on 'SchipEnrollmentState', fields ['year', 'state']
        db.create_unique('data_schipenrollmentstate', ['year', 'state_id'])

        # Adding model 'SchipEnrollmentStateRaw'
        db.create_table('data_schipenrollmentstateraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('data', ['SchipEnrollmentStateRaw'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SchipEnrollmentState', fields ['year', 'state']
        db.delete_unique('data_schipenrollmentstate', ['year', 'state_id'])
        ...
        # Deleting model 'SchipEnrollmentState'
        db.delete_table('data_schipenrollmentstate')

        # Deleting model 'SchipEnrollmentStateRaw'
        db.delete_table('data_schipenrollmentstateraw')
