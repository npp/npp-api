...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UsaspendingAssistanceRaw.recipient_state_code'
        db.alter_column('data_usaspendingassistanceraw', 'recipient_state_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'UsaspendingAssistanceRaw.recipient_county_code'
        db.alter_column('data_usaspendingassistanceraw', 'recipient_county_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'UsaspendingAssistanceRaw.recipient_state_code'
        db.alter_column('data_usaspendingassistanceraw', 'recipient_state_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'UsaspendingAssistanceRaw.recipient_county_code'
        db.alter_column('data_usaspendingassistanceraw', 'recipient_county_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10))
