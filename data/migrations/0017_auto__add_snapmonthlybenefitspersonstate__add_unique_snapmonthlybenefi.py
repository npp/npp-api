...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SnapMonthlyBenefitsPersonState'
        db.create_table('data_snapmonthlybenefitspersonstate', (
        ...
        db.send_create_signal('data', ['SnapMonthlyBenefitsPersonState'])

        # Adding unique constraint on 'SnapMonthlyBenefitsPersonState', fields ['year', 'state']
        db.create_unique('data_snapmonthlybenefitspersonstate', ['year', 'state_id'])

        # Adding model 'SnapParticipationHouseholdsState'
        db.create_table('data_snapparticipationhouseholdsstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.State'])),
        ...
        db.send_create_signal('data', ['SnapParticipationHouseholdsState'])

        # Adding unique constraint on 'SnapParticipationHouseholdsState', fields ['year', 'state']
        db.create_unique('data_snapparticipationhouseholdsstate', ['year', 'state_id'])

        # Adding model 'SnapMonthlyBenefitsPersonStateRaw'
        db.create_table('data_snapmonthlybenefitspersonstateraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('data', ['SnapMonthlyBenefitsPersonStateRaw'])

        # Adding model 'SnapParticipationPeopleStateRaw'
        db.create_table('data_snapparticipationpeoplestateraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('value', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ...
        db.send_create_signal('data', ['SnapParticipationPeopleStateRaw'])

        # Adding model 'SnapParticipationHouseholdsStateRaw'
        db.create_table('data_snapparticipationhouseholdsstateraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('value', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ...
        db.send_create_signal('data', ['SnapParticipationHouseholdsStateRaw'])

        # Adding model 'SnapParticipationPeopleState'
        db.create_table('data_snapparticipationpeoplestate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.State'])),
            ('value', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ...
        db.send_create_signal('data', ['SnapParticipationPeopleState'])

        # Adding unique constraint on 'SnapParticipationPeopleState', fields ['year', 'state']
        db.create_unique('data_snapparticipationpeoplestate', ['year', 'state_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SnapParticipationPeopleState', fields ['year', 'state']
        db.delete_unique('data_snapparticipationpeoplestate', ['year', 'state_id'])

        # Removing unique constraint on 'SnapParticipationHouseholdsState', fields ['year', 'state']
        db.delete_unique('data_snapparticipationhouseholdsstate', ['year', 'state_id'])

        # Removing unique constraint on 'SnapMonthlyBenefitsPersonState', fields ['year', 'state']
        db.delete_unique('data_snapmonthlybenefitspersonstate', ['year', 'state_id'])

        # Deleting model 'SnapMonthlyBenefitsPersonState'
        db.delete_table('data_snapmonthlybenefitspersonstate')

        # Deleting model 'SnapParticipationHouseholdsState'
        db.delete_table('data_snapparticipationhouseholdsstate')

        # Deleting model 'SnapMonthlyBenefitsPersonStateRaw'
        db.delete_table('data_snapmonthlybenefitspersonstateraw')

        # Deleting model 'SnapParticipationPeopleStateRaw'
        db.delete_table('data_snapparticipationpeoplestateraw')

        # Deleting model 'SnapParticipationHouseholdsStateRaw'
        db.delete_table('data_snapparticipationhouseholdsstateraw')

        # Deleting model 'SnapParticipationPeopleState'
        db.delete_table('data_snapparticipationpeoplestate')
