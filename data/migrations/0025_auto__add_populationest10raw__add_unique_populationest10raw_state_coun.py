...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PopulationEst10Raw'
        db.create_table('data_populationest10raw', (
            ...
            ('estimatesbase2010', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2010', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2011', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2012', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2013', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2014', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2015', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2016', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2017', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2018', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2019', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('census2020pop', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('popestimate2020', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('data', ['PopulationEst10Raw'])

        # Adding unique constraint on 'PopulationEst10Raw', fields ['state', 'county', 'gender', 'ethnic_origin', 'race']
        db.create_unique('data_populationest10raw', ['state', 'county', 'gender', 'ethnic_origin', 'race'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PopulationEst10Raw', fields ['state', 'county', 'gender', 'ethnic_origin', 'race']
        db.delete_unique('data_populationest10raw', ['state', 'county', 'gender', 'ethnic_origin', 'race'])

        # Deleting model 'PopulationEst10Raw'
        db.delete_table('data_populationest10raw')
