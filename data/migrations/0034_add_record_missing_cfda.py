...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        try:
            missing_cfda = orm.Cfda.objects.get(program_number='99.999')
        except:
            missing_cfda = orm.Cfda()
            missing_cfda.program_title = 'Missing or Unknown'
            missing_cfda.program_number = '99.999'
            missing_cfda.published_date = '1980-01-01'
            missing_cfda.save()
