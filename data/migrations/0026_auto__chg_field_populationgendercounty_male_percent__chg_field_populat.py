...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PopulationGenderCounty.male_percent'
        with warnings.catch_warnings():
            warnings.simplefilter("ignore")
            db.alter_column('data_populationgendercounty', 'male_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'PopulationGenderCounty.female_percent'
        with warnings.catch_warnings():
            warnings.simplefilter("ignore")
            db.alter_column('data_populationgendercounty', 'female_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'PopulationGenderState.male_percent'
        with warnings.catch_warnings():
            warnings.simplefilter("ignore")
            db.alter_column('data_populationgenderstate', 'male_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'PopulationGenderState.female_percent'
        with warnings.catch_warnings():
            warnings.simplefilter("ignore")
            db.alter_column('data_populationgenderstate', 'female_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'PopulationGenderCounty.male_percent'
        db.alter_column('data_populationgendercounty', 'male_percent', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'PopulationGenderCounty.female_percent'
        db.alter_column('data_populationgendercounty', 'female_percent', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'PopulationGenderState.male_percent'
        db.alter_column('data_populationgenderstate', 'male_percent', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'PopulationGenderState.female_percent'
        db.alter_column('data_populationgenderstate', 'female_percent', self.gf('django.db.models.fields.FloatField')())
