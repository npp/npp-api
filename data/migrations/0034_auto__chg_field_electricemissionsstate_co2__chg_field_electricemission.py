...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ElectricEmissionsState.co2'
        db.alter_column('data_electricemissionsstate', 'co2', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'ElectricEmissionsState.so2'
        db.alter_column('data_electricemissionsstate', 'so2', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'ElectricEmissionsState.nox'
        db.alter_column('data_electricemissionsstate', 'nox', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'ElectricEmissionsStateRaw.co2'
        db.alter_column('data_electricemissionsstateraw', 'co2', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'ElectricEmissionsStateRaw.so2'
        db.alter_column('data_electricemissionsstateraw', 'so2', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'ElectricEmissionsStateRaw.nox'
        db.alter_column('data_electricemissionsstateraw', 'nox', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ElectricEmissionsState.co2'
        db.alter_column('data_electricemissionsstate', 'co2', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'ElectricEmissionsState.so2'
        db.alter_column('data_electricemissionsstate', 'so2', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'ElectricEmissionsState.nox'
        db.alter_column('data_electricemissionsstate', 'nox', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'ElectricEmissionsStateRaw.co2'
        db.alter_column('data_electricemissionsstateraw', 'co2', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'ElectricEmissionsStateRaw.so2'
        db.alter_column('data_electricemissionsstateraw', 'so2', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'ElectricEmissionsStateRaw.nox'
        db.alter_column('data_electricemissionsstateraw', 'nox', self.gf('django.db.models.fields.BigIntegerField')(default=0))
    ...
    models = {
        ...
        'data.electricemissionsstate': {
            ...
            'co2': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'energy_source': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nox': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'producer_type': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'so2': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.State']"}),
            'update_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'year': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        'data.usaspendingassistancecounty': {
            'Meta': {'unique_together': "(('year', 'cfda', 'state', 'county'),)", 'object_name': 'UsaspendingAssistanceCounty'},
            'cfda': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.Cfda']"}),
            'county': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.County']"}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fed_funding': ('django.db.models.fields.BigIntegerField', [], {}),
            'fed_funding_per_capita': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loan_subsidy': ('django.db.models.fields.BigIntegerField', [], {}),
            'loan_subsidy_per_capita': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2'}),
            'loan_value': ('django.db.models.fields.BigIntegerField', [], {}),
            'loan_value_per_capita': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.State']"}),
            'update_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'year': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        'data.usaspendingassistancestate': {
            'Meta': {'unique_together': "(('year', 'cfda', 'state'),)", 'object_name': 'UsaspendingAssistanceState'},
            'cfda': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.Cfda']"}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fed_funding': ('django.db.models.fields.BigIntegerField', [], {}),
            'fed_funding_per_capita': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2'}),
