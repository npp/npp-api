...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming model 'FamiliesPoverty'
        db.rename_table('data_familiespoverty', 'data_familiespovertystateraw')
        db.send_create_signal('data', ['FamiliesPovertyRaw'])

        # Renaming model 'PeopleInPoverty'
        db.rename_table('data_peopleinpoverty', 'data_peoplepovertystateraw')
        db.send_create_signal('data', ['PeoplePovertyRaw'])

        # Renaming model 'ChildrenPoverty'
        db.rename_table('data_childrenpoverty', 'data_childrenpovertystateraw')
        db.send_create_signal('data', ['ChildrenPovertyRaw'])
        
        # Renaming model 'PeopleInPovertyState'
        db.rename_table('data_peopleinpovertystate', 'data_peoplepovertystate')
        db.send_create_signal('data', ['PeoplePovertyState'])


    def backwards(self, orm):
        
        # Renaming model 'FamiliesPovertyStateRaw'
        db.rename_table('data_familiespovertystateraw', 'data_familiespoverty')
        db.send_create_signal('data', ['FamiliesPoverty'])

        # Renaming model 'PeoplePovertyStateRaw'
        db.rename_table('data_peoplepovertystateraw', 'data_peopleinpoverty')
        db.send_create_signal('data', ['PeopleInPoverty'])

        # Renaming model 'ChildrenPovertyStateRaw'
        db.rename_table('data_childrenpovertystateraw', 'data_childrenpoverty')
        db.send_create_signal('data', ['ChildrenPoverty'])
        
        # Renaming model 'PeopleInPovertyStateRaw'
        db.rename_table('data_peoplepovertystate', 'data_peopleinpovertystate')
    ...
    models = {
        ...
        'data.childrenpovertyraw': {
            'Meta': {'object_name': 'ChildrenPovertyRaw'},
        ...
        'data.familiespovertyraw': {
            'Meta': {'object_name': 'FamiliesPovertyRaw'},
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'data.peoplepovertyraw': {
            'Meta': {'object_name': 'PeoplePovertyRaw'},
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
