...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'EnergyConsumptionState', fields ['msn', 'state', 'year']
        db.create_unique('data_energyconsumptionstate', ['msn_id', 'state_id', 'year'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'EnergyConsumptionState', fields ['msn', 'state', 'year']
        db.delete_unique('data_energyconsumptionstate', ['msn_id', 'state_id', 'year'])
