...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LaborForceState'
        db.create_table('data_laborforcestate', (
            ...
            ('labor_force_total', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('data', ['LaborForceState'])

        # Adding unique constraint on 'LaborForceState', fields ['year', 'state']
        db.create_unique('data_laborforcestate', ['year', 'state_id'])

        # Adding model 'LaborForceStateRaw'
        db.create_table('data_laborforcestateraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area_fips', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ...
        db.send_create_signal('data', ['LaborForceStateRaw'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'LaborForceState', fields ['year', 'state']
        db.delete_unique('data_laborforcestate', ['year', 'state_id'])
        ...
        # Deleting model 'LaborForceState'
        db.delete_table('data_laborforcestate')

        # Deleting model 'LaborForceStateRaw'
        db.delete_table('data_laborforcestateraw')
