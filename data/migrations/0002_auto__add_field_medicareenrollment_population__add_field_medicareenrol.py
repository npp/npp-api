...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MedicareEnrollment.population'
        db.add_column('data_medicareenrollment', 'population', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'MedicareEnrollment.percent'
        db.add_column('data_medicareenrollment', 'percent', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'MedicareEnrollment.create_date'
        db.add_column('data_medicareenrollment', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 3, 15), blank=True), keep_default=False)

        # Adding field 'MedicareEnrollment.update_date'
        db.add_column('data_medicareenrollment', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 3, 15), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MedicareEnrollment.population'
        db.delete_column('data_medicareenrollment', 'population')

        # Deleting field 'MedicareEnrollment.percent'
        db.delete_column('data_medicareenrollment', 'percent')

        # Deleting field 'MedicareEnrollment.create_date'
        db.delete_column('data_medicareenrollment', 'create_date')

        # Deleting field 'MedicareEnrollment.update_date'
        db.delete_column('data_medicareenrollment', 'update_date')
