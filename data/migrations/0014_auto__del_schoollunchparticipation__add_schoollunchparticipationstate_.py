...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SchoolLunchParticipationState'
        db.create_table('data_schoollunchparticipationstate', (
        ...
        db.send_create_signal('data', ['SchoolLunchParticipationState'])

        # Adding unique constraint on 'SchoolLunchParticipationState', fields ['year', 'state']
        db.create_unique('data_schoollunchparticipationstate', ['year', 'state_id'])

        # Adding model 'SchoolLunchParticipationStateRaw'
        db.create_table('data_schoollunchparticipationstateraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('data', ['SchoolLunchParticipationStateRaw'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SchoolLunchParticipationState', fields ['year', 'state']
        db.delete_unique('data_schoollunchparticipationstate', ['year', 'state_id'])
        ...
        # Deleting model 'SchoolLunchParticipationState'
        db.delete_table('data_schoollunchparticipationstate')

        # Deleting model 'SchoolLunchParticipationStateRaw'
        db.delete_table('data_schoollunchparticipationstateraw')
