...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EnergyConsumptionStateRaw.value'
        db.alter_column('data_energyconsumptionstateraw', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'EnergyConsumptionState.value'
        db.alter_column('data_energyconsumptionstate', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'EnergyConsumptionStateRaw.value'
        db.alter_column('data_energyconsumptionstateraw', 'value', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'EnergyConsumptionState.value'
        db.alter_column('data_energyconsumptionstate', 'value', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        'data.energyconsumptionstate': {
            ...
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.State']"}),
            'update_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2'}),
            'year': ('django.db.models.fields.IntegerField', [], {})
        },
