...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsaspendingAssistanceRaw'
        db.create_table('data_usaspendingassistanceraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cfda_program', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('cfda_program_title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('agency_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('agency_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('recipient_county_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('recipient_state_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('recipient_country_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('assistance_type', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('assistance_type_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('fiscal_year', self.gf('django.db.models.fields.IntegerField')()),
            ('asst_cat_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('recip_cat_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('recip_cat_type_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('fed_funding_amount', self.gf('django.db.models.fields.BigIntegerField')()),
            ('non_fed_funding_amount', self.gf('django.db.models.fields.BigIntegerField')()),
            ('total_funding_amount', self.gf('django.db.models.fields.BigIntegerField')()),
            ('face_loan_guran', self.gf('django.db.models.fields.BigIntegerField')()),
            ('orig_sub_guran', self.gf('django.db.models.fields.BigIntegerField')()),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('data', ['UsaspendingAssistanceRaw'])


    def backwards(self, orm):
        # Deleting model 'UsaspendingAssistanceRaw'
        db.delete_table('data_usaspendingassistanceraw')
    ...
    models = {
        ...
        'data.usaspendingassistanceraw': {
            ...
            'cfda_program': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
