...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('data_cfda', (
            ...
            ('program_title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('program_number', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('popular_name', self.gf('django.db.models.fields.TextField')()),
            ('agency_name', self.gf('django.db.models.fields.TextField')()),
            ('authorization', self.gf('django.db.models.fields.TextField')()),
            ('objective', self.gf('django.db.models.fields.TextField')()),
            ('assistance_type', self.gf('django.db.models.fields.TextField')()),
            ('use', self.gf('django.db.models.fields.TextField')()),
            ('applicant_eligibility', self.gf('django.db.models.fields.TextField')()),
            ('beneficiary_eligibility', self.gf('django.db.models.fields.TextField')()),
            ('credentials', self.gf('django.db.models.fields.TextField')()),
            ('preapplication_coordination', self.gf('django.db.models.fields.TextField')()),
            ('application_procedure', self.gf('django.db.models.fields.TextField')()),
            ('award_procedure', self.gf('django.db.models.fields.TextField')()),
            ('deadline', self.gf('django.db.models.fields.TextField')()),
            ('approval_time_range', self.gf('django.db.models.fields.TextField')()),
            ('appeals', self.gf('django.db.models.fields.TextField')()),
            ('renewal', self.gf('django.db.models.fields.TextField')()),
            ('formula_matching_grant_request', self.gf('django.db.models.fields.TextField')()),
            ('assistance_length_time', self.gf('django.db.models.fields.TextField')()),
            ('reports', self.gf('django.db.models.fields.TextField')()),
            ('audits', self.gf('django.db.models.fields.TextField')()),
            ('record', self.gf('django.db.models.fields.TextField')()),
            ('account_id', self.gf('django.db.models.fields.TextField')()),
            ('obligations', self.gf('django.db.models.fields.TextField')()),
            ('range_average_assistance', self.gf('django.db.models.fields.TextField')()),
            ('accomplishments', self.gf('django.db.models.fields.TextField')()),
            ('regulations', self.gf('django.db.models.fields.TextField')()),
            ('regional_local_office', self.gf('django.db.models.fields.TextField')()),
            ('headquarters_office', self.gf('django.db.models.fields.TextField')()),
            ('web_address', self.gf('django.db.models.fields.TextField')()),
            ('example_projects', self.gf('django.db.models.fields.TextField')()),
            ('selection_criteria', self.gf('django.db.models.fields.TextField')()),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('recovery_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('omb_agency_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('omb_bureau_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ...
        db.send_create_signal('data', ['Cfda'])


    def backwards(self, orm):
        # Deleting model 'Cfda'
        db.delete_table('data_cfda')
    ...
    models = {
        ...
        'data.cfda': {
            ...
            'program_number': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
