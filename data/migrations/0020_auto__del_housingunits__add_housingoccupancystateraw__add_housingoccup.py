...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HousingOccupancyStateRaw'
        db.create_table('data_housingoccupancystateraw', (
            ...
            ('total_units', self.gf('django.db.models.fields.IntegerField')()),
            ('total_units_moe', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('occupied_units', self.gf('django.db.models.fields.IntegerField')()),
            ('occupied_units_moe', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('occupied_units_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2)),
            ('occupied_units_percent_moe', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('vacant_units', self.gf('django.db.models.fields.IntegerField')()),
            ('vacant_units_moe', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('vacant_units_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2)),
            ('vacant_units_percent_moe', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('owner_occupied', self.gf('django.db.models.fields.IntegerField')()),
            ('owner_occupied_moe', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('owner_occupied_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2)),
            ('owner_occupied_percent_moe', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('owner_vacancy_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('owner_vacancy_rate_moe', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('renter_occupied', self.gf('django.db.models.fields.IntegerField')()),
            ('renter_occupied_moe', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('renter_occupied_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2)),
            ('renter_occupied_percent_moe', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('renter_vacancy_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('renter_vacancy_rate_moe', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('data', ['HousingOccupancyStateRaw'])

        # Adding model 'HousingOccupancyState'
        db.create_table('data_housingoccupancystate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.State'])),
            ('total_units', self.gf('django.db.models.fields.IntegerField')()),
            ('total_units_moe', self.gf('django.db.models.fields.IntegerField')()),
            ('occupied_units', self.gf('django.db.models.fields.IntegerField')()),
            ('occupied_units_moe', self.gf('django.db.models.fields.IntegerField')()),
            ('occupied_units_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('occupied_units_percent_moe', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('vacant_units', self.gf('django.db.models.fields.IntegerField')()),
            ('vacant_units_moe', self.gf('django.db.models.fields.IntegerField')()),
            ('vacant_units_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('vacant_units_percent_moe', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('owner_occupied', self.gf('django.db.models.fields.IntegerField')()),
            ('owner_occupied_moe', self.gf('django.db.models.fields.IntegerField')()),
            ('owner_occupied_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('owner_occupied_percent_moe', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('owner_vacancy_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('owner_vacancy_rate_moe', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('renter_occupied', self.gf('django.db.models.fields.IntegerField')()),
            ('renter_occupied_moe', self.gf('django.db.models.fields.IntegerField')()),
            ('renter_occupied_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('renter_occupied_percent_moe', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('renter_vacancy_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('renter_vacancy_rate_moe', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('data', ['HousingOccupancyState'])

        # Adding unique constraint on 'HousingOccupancyState', fields ['year', 'state']
        db.create_unique('data_housingoccupancystate', ['year', 'state_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'HousingOccupancyState', fields ['year', 'state']
        db.delete_unique('data_housingoccupancystate', ['year', 'state_id'])
        ...
        # Deleting model 'HousingOccupancyStateRaw'
        db.delete_table('data_housingoccupancystateraw')

        # Deleting model 'HousingOccupancyState'
        db.delete_table('data_housingoccupancystate')
