...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EnergyConsumptionStateRaw'
        db.create_table('data_energyconsumptionstateraw', (
        ...
        db.send_create_signal('data', ['EnergyConsumptionStateRaw'])

        # Adding model 'Msn'
        db.create_table('data_msn', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('msn_code', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('msn_desc', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('msn_unit', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('data', ['Msn'])

        # Adding model 'EnergyConsumptionState'
        db.create_table('data_energyconsumptionstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.State'])),
            ('msn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Msn'])),
            ('value', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('data', ['EnergyConsumptionState'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EnergyConsumptionStateRaw'
        db.delete_table('data_energyconsumptionstateraw')

        # Deleting model 'Msn'
        db.delete_table('data_msn')

        # Deleting model 'EnergyConsumptionState'
        db.delete_table('data_energyconsumptionstate')
    ...
    models = {
        ...
        'data.energyconsumptionstate': {
            'Meta': {'object_name': 'EnergyConsumptionState'},
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
