...
class Command(NoArgsCommand):
    ...
    def handle_noargs(self, **options):
        ...
        #load 2000-2009
        cursor.execute('''
        insert into data_populationracecounty
        select 
            NULL
        ,   case
        ...
        cursor.execute('''
        update data_populationracecounty
        set 
            white_alone_percent = ROUND(white_alone / total,4)
        ,	white_other_percent = ROUND(white_other / total,4)
        ,	white_alone_hispanic_percent = ROUND(white_alone_hispanic / total,4)
        ,	white_other_hispanic_percent = ROUND(white_other_hispanic / total,4)
        ,	white_alone_nonhispanic_percent = ROUND(white_alone_nonhispanic / total,4)
        ,	white_other_nonhispanic_percent = ROUND(white_other_nonhispanic / total,4)
        ,	black_alone_percent = ROUND(black_alone / total,4)
        ,	black_other_percent = ROUND(black_other / total,4)
        ,	black_alone_hispanic_percent = ROUND(black_alone_hispanic / total,4)
        ,	black_other_hispanic_percent = ROUND(black_other_hispanic / total,4)
        ,	black_alone_nonhispanic_percent = ROUND(black_alone_nonhispanic / total,4)
        ,	black_other_nonhispanic_percent = ROUND(black_other_nonhispanic / total,4)
        ,	native_alone_percent = ROUND(native_alone / total,4)
        ,	native_other_percent = ROUND(native_other / total,4)
        ,	native_alone_hispanic_percent = ROUND(native_alone_hispanic / total,4)
        ,	native_other_hispanic_percent = ROUND(native_other_hispanic / total,4)
        ,	native_alone_nonhispanic_percent = ROUND(native_alone_nonhispanic / total,4)
        ,	native_other_nonhispanic_percent = ROUND(native_other_nonhispanic / total,4)
        ,	asian_alone_percent = ROUND(asian_alone / total,4)
        ,	asian_other_percent = ROUND(asian_other / total,4)
        ,	asian_alone_hispanic_percent = ROUND(asian_alone_hispanic / total,4)
        ,	asian_other_hispanic_percent = ROUND(asian_other_hispanic / total,4)
        ,	asian_alone_nonhispanic_percent = ROUND(asian_alone_nonhispanic / total,4)
        ,	asian_other_nonhispanic_percent = ROUND(asian_other_nonhispanic / total,4)
        ,	pacific_islander_alone_percent = ROUND(pacific_islander_alone / total,4)
        ,	pacific_islander_other_percent = ROUND(pacific_islander_other / total,4)
        ,	pacific_islander_alone_hispanic_percent = ROUND(pacific_islander_alone_hispanic / total,4)
        ,	pacific_islander_other_hispanic_percent = ROUND(pacific_islander_other_hispanic / total,4)
        ,	pacific_islander_alone_nonhispanic_percent = ROUND(pacific_islander_alone_nonhispanic / total,4)
        ,	pacific_islander_other_nonhispanic_percent = ROUND(pacific_islander_other_nonhispanic / total,4)
        ,	asian_pacific_islander_alone_percent = ROUND(asian_pacific_islander_alone / total,4)
        ,	other_percent = ROUND(other / total,4)
        ,	multiple_race_percent = ROUND(multiple_race / total,4)
        ,	multiple_race_hispanic_percent = ROUND(multiple_race_hispanic/total,4)
        ,	multiple_race_nonhispanic_percent = ROUND(multiple_race_nonhispanic/total,4)
        ,	hispanic_percent = ROUND(hispanic/total,4)
        ,	nonhispanic_percent = ROUND(nonhispanic/total,4)
        ''')
