        ...
        def load_year(year):
            ...
            for row in data_reader:
                ...
                if len(state):
                    ...
                    record.individual_total = clean_value(row[3])
                    if year > 2008:
                        record.individual_witheld_fica = clean_value(row[4])
                        record.individual_notwitheld_seca = clean_value(row[5])
                        record.individual_unemployment = clean_value(row[6])
                        record.individual_railroad_retirement = clean_value(row[7])
                        record.individual_estate_trust_income = clean_value(row[8])
                        ...
                        record.individual_railroad_retirement = clean_value(row[6])
                        record.individual_unemployment = clean_value(row[7])
