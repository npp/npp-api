...
from data.models import SnapMonthlyBenefitsPersonStateRaw
...
# source info: http://www.fns.usda.gov/pd/18SNAPavg$PP.htm (accurate as of 5/15/2012)
# npp csv: http://assets.nationalpriorities.org/raw_data/hunger/snap_monthly_benefits_person.csv (updated 7/27/2010)
# destination model:  SNAPMonthlyBenefitsPersonStateRaw
                    ...
                    for j,col in enumerate(row):
                        if j > 0:
                            ...
                            try:
                                ...
                                record = SnapMonthlyBenefitsPersonStateRaw.objects.get(state=state, year=int(year_row[j]))
