...
# source info: http://www.fns.usda.gov/pd/04sffypart.htm (accurate as of 6/15/2011)
                    ...
                    for j,col in enumerate(row):
                        if j > 0:
                            try:
                                ...
                                record = SummerLunchParticipation.objects.get(state=state, year=int(year_row[j]))
