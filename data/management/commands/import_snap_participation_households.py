...
from data.models import SnapParticipationHouseholdsStateRaw
...
# source info: http://www.fns.usda.gov/pd/16SNAPpartHH.htm (accurate as of 5/15/2012)
# npp csv: http://assets.nationalpriorities.org/raw_data/hunger/snap_participation_households.csv (updated 7/27/2010)
# destination model:  SnapParticipationHouseholdsStateRaw
...
class Command(NoArgsCommand):
    ...
    def handle_noargs(self, **options):
                    ...
                    for j,col in enumerate(row):
                        if j > 0:
                            ...
                            try:
                                ...
                                record = SnapParticipationHouseholdsStateRaw.objects.get(state=state, year=int(year_row[j]))
                                ...
                                record = SnapParticipationHouseholdsStateRaw()
        ...
        db.reset_queries()
        print 'snap household import complete. %s inserted, %s updated, %s unchanged' % (
